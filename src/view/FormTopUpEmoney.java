    ...
    public void showFormTopUpEmoney() {
        ...
        topUpButton.addActionListener(e -> {
            ...
            try {
                ...
                if (amount < 10000) {
                    JOptionPane.showMessageDialog(frame, "Jumlah saldo tidak boleh kurang dari 10.000.", "Error",
                ...
                if (promoValid || promoCode.isEmpty()) {
                    frame.dispose();
                    new MenuBonTransaksi(TransaksiType.TOPUP, promoValid, amount, Integer.parseInt(eMoneyInput), 2500.0,
                            topUpType);
                } else {
